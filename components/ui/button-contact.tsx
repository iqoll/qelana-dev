...
export default function ButtonContact({ variant = "large", className = "" }: ButtonContactProps) {
  ...
  return (
    <a
      href="https://wa.me/6285713849998?text=Halo,%20saya%20ingin%20berkonsultasi%20mengenai%20jasa%20pembuatan%20website"
